function login(){
    var url ="https://ums-dev.husc.edu.vn/apigateway/account/v1/authorize/teacher";
    ...
    callApi(url,'Post', headers, {
      ...
      if(data.data.Data == null){
        ...
        callApi(url,"get", headers, null,).then(data => {
          ...
          localStorage.setItem('infoTeacher',JSON.stringify(data.data.Data));
          window.location = "http://127.0.0.1:5500/teacher/"+ "cvht-home-teacher.html";        
        });
